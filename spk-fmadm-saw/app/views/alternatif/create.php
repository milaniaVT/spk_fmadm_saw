            ...
            <div class="row g-4">
                    ...
                    <?php foreach ($data['c1'] as $key) : ?>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="c1" id="c1" value="<?=$key['id_sub'];?>" required>
                                <?= $key['nama_sub']; ?>
                            </label>
                        </div>
                    <?php endforeach; ?>
                ...
                <div class="col-12">
                    ...
                    <?php foreach ($data['c2'] as $key) : ?>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="c2" id="c2" value="<?=$key['id_sub'];?>" required>
                                <?= $key['nama_sub']; ?>
                            </label>
                        </div>
                    <?php endforeach; ?>
                ...
                <div class="col-12">
                    ...
                    <?php foreach ($data['c4'] as $key) : ?>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="c4" id="c4" value="<?= $key['id_sub']; ?>" required>
                                <?= $key['nama_sub']; ?>
                            </label>
                        </div>
                    <?php endforeach; ?>
                ...
                <div class="col-12">
                    ...
                    <?php foreach ($data['c5'] as $key) : ?>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="c5" id="c5" value="<?= $key['id_sub']; ?>" required>
                                <?= $key['nama_sub']; ?>
                            </label>
                        </div>
                    <?php endforeach; ?>
                ...
                <div class="col-12">
                    ...
                    <?php foreach ($data['c6'] as $key) : ?>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="c6" id="c6" value="<?= $key['id_sub'] ?>" required>
                                <?= $key['nama_sub']; ?>
                            </label>
                        </div>
                    <?php endforeach; ?>
